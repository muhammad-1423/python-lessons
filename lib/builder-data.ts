...
export const planCatalog = [
  { key: 'free', name: 'Free', price: 0, credits: 25, features: ['1 draft project', 'Builder preview', 'Starter templates'] },
  { key: 'pro', name: 'Pro', price: 29, credits: 500, features: ['Unlimited projects', 'Export code', 'Deployments', 'Custom domains'] },
  { key: 'team', name: 'Team', price: 99, credits: 2500, features: ['Team seats', 'Shared projects', 'Admin controls', 'Priority support'] }
] as const;
